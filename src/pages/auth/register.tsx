        ...
        <main>
            ...
            <div className="py-16 contain">
                <div className="max-w-lg px-6 mx-auto overflow-hidden rounded shadow py-7">
                    ...
                    <form action="#" method="post" autoComplete="off">
                        <div className="space-y-2">
                            <div>
                                ...
                                <input type="text" name="name" id="name" className="block w-full px-4 py-3 text-sm text-gray-600 placeholder-gray-400 border border-gray-300 rounded focus:ring-0 focus:border-primary" placeholder="fulan fulana" />
                            </div>
                            <div>
                            ...
                            <div>
                                <label htmlFor="confirm" className="block mb-2 text-gray-600">Confirm password</label>
                                <input type="password" name="confirm" id="confirm" className="block w-full px-4 py-3 text-sm text-gray-600 placeholder-gray-400 border border-gray-300 rounded focus:ring-0 focus:border-primary" placeholder="*******" />
                            </div>
                        </div>
                        <div className="mt-6">
                            <div className="flex items-center">
                                <input type="checkbox" name="aggrement" id="aggrement" className="rounded-sm cursor-pointer text-primary focus:ring-0" />
                                <label htmlFor="aggrement" className="ml-3 text-gray-600 cursor-pointer">I have read and agree to the <a href="#" className="text-primary">terms &amp; conditions</a></label>
                            </div>
                        </div>
                        <div className="mt-4">
                            <button onClick={CreateUser} type="submit" className="block w-full py-2 font-medium text-center text-white uppercase transition border rounded bg-primary border-primary hover:bg-transparent hover:text-primary font-roboto">create
                                account</button>
                        </div>
                    </form>
                    {/* login with */}
                    <div className="relative flex justify-center mt-6">
                        <div className="relative z-10 px-3 text-gray-600 uppercase bg-white">Or signup with</div>
                    ...
                    {/* ./login with */}
                    <p className="mt-4 text-center text-gray-600">Already have account? <a href="/auth/login" className="text-primary">Login now</a></p>
                </div>
            </div>
            <Footer />
